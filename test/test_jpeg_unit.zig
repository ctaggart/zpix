...
test "JPEG decoder handles minimal valid baseline JPEG" {
    ...
    var img = try zpix.loadJpegFile(allocator, "test/fixtures/test_rgb_4x4.jpg", std.testing.io);
    defer img.deinit();
...
test "JPEG decoder handles grayscale image" {
    ...
    var img = try zpix.loadJpegFile(allocator, "test/fixtures/test_gray_8x8.jpg", std.testing.io);
    defer img.deinit();
...
test "JPEG decoder handles progressive JPEG" {
    ...
    var img = try zpix.loadJpegFile(allocator, "test/fixtures/test_rgb_4x4_progressive.jpg", std.testing.io);
    defer img.deinit();
...
test "JPEG decoder allocates correct amount of memory" {
    ...
    var img = try zpix.loadJpegFile(allocator, "test/fixtures/landscape_600x400.jpg", std.testing.io);
    defer img.deinit();
